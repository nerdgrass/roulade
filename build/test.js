...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Reducer', function () {
	  context('Query Request', function () {
	    var mockQueryRequest = {
	      type: 'ROULADE_QUERY_REQUEST',
	      fragment: mockSchema
	    };
	    it('injects loading status into state w/ value of loading', function () {
	      (0, _chai.expect)(reducer(mockState, mockQueryRequest)).to.have.deep.property('parentState.parentStateQueryStatus', 'loading');
	    });
	  });
	  context('Query Success', function () {
	    var mockQuerySuccess = {
	      type: 'ROULADE_QUERY_SUCCESS',
	      response: mockResponse,
	      fragment: mockSchema
	    };
	    it('injects response into state', function () {
	      (0, _chai.expect)(reducer(mockState, mockQuerySuccess)).to.have.deep.property('parentState.childState', mockResponse);
	    });
	    it('updates loading cursor to have value of loaded', function () {
	      (0, _chai.expect)(reducer(mockState, mockQuerySuccess)).to.have.deep.property('parentState.parentStateQueryStatus', 'loaded');
	    });
	  });
	  context('Query Error', function () {
	    var mockQueryError = {
	    ...
	    it('updates loading cursor to have value of error', function () {
	      (0, _chai.expect)(reducer(mockState, mockQueryError)).to.have.deep.property('parentState.parentStateQueryStatus', 'error');
	    });
	  });
	});
